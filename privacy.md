---
layout: page
title: Biblity Privacy Policy
permalink: /biblity/privacy/
---

# Biblity 개인정보처리방침 | Privacy Policy | プライバシーポリシー
...
앱은 성경 구절, 즐겨찾기, 알림 설정 등 사용자가 앱 안에서 입력하거나 생성한 데이터를 기기 내에 저장합니다. 프리미엄 사용자가 iCloud 동기화를 켠 경우 해당 데이터가 사용자의 Apple 계정에 연결된 iCloud에 동기화될 수 있습니다. 앱은 별도의 회원가입을 요구하지 않으며, 광고 목적으로 개인정보를 수집하거나 판매하지 않습니다. 구독 결제는 Apple App Store를 통해 처리되며 앱은 결제 정보를 직접 보관하지 않습니다.
...
본 방침이 변경되는 경우 이 페이지를 통해 안내합니다. Changes to this policy will be posted on this page. 本ポリシーの変更はこのページでお知らせします。
